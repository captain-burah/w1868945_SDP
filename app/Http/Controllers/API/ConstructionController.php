...
class ConstructionController extends Controller
{
    public function index(){
        $resources = WebsiteConstruction::with('website_construction_images')->select('id', 'title', 'title_ar', 'description', 'description_ar', 'growth', 'slug_link', 'thumbnail', 'created_at')->where('status', '1')->get();
