<div class="card">
    <div class="card-body">
        <h3 class="mb-1">Release NEWS Article </h3>
    ...
    <form class="contact-form" method="post" action="{{ route('website-news.store') }}" enctype="multipart/form-data" id="dropzone">
            @csrf
