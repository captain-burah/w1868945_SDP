                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('website-blogs.edit', ['website_blog' => $value->id]) }}"><i class="bx bx-edit text-dark"></i> &nbsp;Update</a>
                                            <form action="{{ route('website-blogs.destroy', ['website_blog' => $value->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
