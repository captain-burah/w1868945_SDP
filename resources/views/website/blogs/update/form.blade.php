...
<div class="card">
    <div class="card-body">
        ...
        <form class="contact-form" id="getInTouch" method="post" action="{{ route('website-blogs.update', ['website_blog' => $resources->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="flex-none w-100 mt-3 ">
                <a href="{{ route('website-blogs.index') }}" class="btn btn-sm btn-outline-dark mt-3 my-auto">
