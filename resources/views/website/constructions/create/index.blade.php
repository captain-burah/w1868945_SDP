...
<div style="padding-top: 150px;">
    ...
    @include('website.constructions.create.form')
...
@section('appIn_js')
    ...
    <script>
        ...
        //meta titles
        var property_title = 60;
        $("#property_title_ar").keyup(function()  {
            var length = $(this).val().length;
            var length = property_title-length;
            $('#property_title_chars_ar').text(length);
        });

        //meta titles
        var meta_title_en_maxLenght = 60;
        $("#meta_title_ar").keyup(function()  {
            var length = $(this).val().length;
            var length = meta_title_en_maxLenght-length;
            $('#meta_title_en_chars_ar').text(length);
        });
        ...
        $("#meta_keywords_ar").keyup(function()  {
            var length = $(this).val().length;
            var length = meta_keywords_en_maxLenght-length;
            $('#meta_keywords_en_chars_ar').text(length);
        });
        ...
        $("#meta_description_ar").keyup(function()  {
            var length = $(this).val().length;
            var length = meta_description_en_maxLenght-length;
            $('#meta_description_en_chars_ar').text(length);
        });
