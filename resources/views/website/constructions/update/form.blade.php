...
<div class="card">
    <div class="card-body">
        <h3 class="mb-1">Construction Notice Update</h3>
        ...
        <form class="contact-form" id="getInTouch" method="post" action="{{ route('website-constructions.update', ['website_construction' => $resources->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
