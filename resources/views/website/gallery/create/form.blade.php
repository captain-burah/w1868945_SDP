<div class="card">
    ...
    <form class="contact-form" method="post" action="{{ route('website-gallery.store') }}" enctype="multipart/form-data" id="dropzone">
            @csrf
