                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('website-gallery.edit', ['website_gallery' => $value->id]) }}"><i class="bx bx-edit text-dark"></i> &nbsp;Update</a>
                                            <form action="{{ route('website-gallery.destroy', ['website_gallery' => $value->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
