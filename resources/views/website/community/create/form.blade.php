<div class="card">
    <div class="card-body">
        <h3 class="mb-1">Add Community </h3>
    ...
    <form class="contact-form" method="post" action="{{ route('communities.store') }}" enctype="multipart/form-data" id="dropzone">
            @csrf
