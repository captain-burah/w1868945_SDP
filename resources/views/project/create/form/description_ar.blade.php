        ...
        <div class="mb-4">
            ...
            <div class="w-100 ">
                <div class="my-2">
                    ...
                    @enderror
                    <textarea name="description_ar" id="description_ar" class="form-control w-100" rows="5">{{ old('description_ar') }}</textarea>
            ...
            <div class="w-100 ">
                <div class="my-2">
                    @error('secOne_description_ar')
                        <div class="text-danger text-xs" >{{ $message }}</div>
                    @enderror
                    <textarea name="secOne_description_ar" id="secOne_description_ar" class="form-control w-100" rows="5">{{ old('secOne_description_ar') }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="w-100 ">
                <div class="my-2">
                    @error('secTwo_description_ar')
                        <div class="text-danger text-xs" >{{ $message }}</div>
                    @enderror
                    <textarea name="secTwo_description_ar" id="secTwo_description_ar" class="form-control w-100" rows="5">{{ old('secTwo_description_ar') }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="w-100 ">
                <div class="my-2">
                    @error('secTwo_amenities_ar')
                        <div class="text-danger text-xs" >{{ $message }}</div>
                    @enderror
                    <textarea name="secTwo_amenities_ar" id="secTwo_amenities_ar" class="form-control w-100 textareablock" rows="5">{{ old('secTwo_amenities_ar') }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="w-100 ">
                <div class="my-1">
                    ...
                    <input
                        ...
                        maxlength="255"
                        class="form-control
                        @error('secThree_title_ar') border border-solid border-danger  @enderror"
                        value="{{ old('secThree_title_ar') }}"
                    >
                </div>
            </div>
        </div>
            ...
            <div class="w-100 ">
                <div class="my-2">
                    @error('secThree_description_ar')
                        <div class="text-danger text-xs" >{{ $message }}</div>
                    @enderror
                    <textarea name="secThree_description_ar" id="secThree_description_ar" class="form-control w-100" rows="5">{{ old('secThree_description_ar') }}</textarea>
                </div>
            </div>
        </div>
    </div>
