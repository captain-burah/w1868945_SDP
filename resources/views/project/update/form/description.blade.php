        ...
        <div class="mb-4">
            ...
            <div class="w-100 ">
                <div class="my-2">
                    ...
                    @enderror
                    <textarea name="description" id="description" class="form-control w-100" rows="5">{{ $project->description }}</textarea>
