    ...
    <div class="card-body">
        ...
        <form class="contact-form" id="getInTouch" method="post" action="{{ route('projects.update', ['project' => $project->id]) }}" enctype="multipart/form-data">
            ...
            <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button style="width: auto" class="nav-link" id="description-tab" data-toggle="tab" data-target="#description_ar" type="button" role="tab" aria-controls="contact" aria-selected="false">Description Ar</button>
                </li>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade p-4" id="description_ar" role="tabpanel" aria-labelledby="description-tab">
                    @include('project.update.form.description_ar')
                </div>
