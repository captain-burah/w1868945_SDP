<div class="card">
    <div class="card-body">
        <h3 class="mb-1">Factsheet Segmenting</h3>
        ...
        <div class="my-4">
            <form class="contact-form" action="{{ route('project-factsheet.store')  }}" method="POST" enctype="multipart/form-data" id="dropzone"
            >
                @csrf
                <div class="flex-none w-100 my-4 ">
                    <a href="{{ route('project-factsheet.index') }}" class="btn btn-sm btn-outline-dark mt-3 my-auto">
