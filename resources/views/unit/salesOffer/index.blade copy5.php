...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            html, body {
                width: 210mm; /* A4 portrait width in millimeters */
                height: auto; /* Content will adjust to fit the width */
                ...
                <div class="shadow-none m-5" style="background-color: #fff; border: 0;">
                    ...
                    <div class="card-body p-0 mt-2">
                        <div class="p-0">
                            ...
                            <div class="mt-3">
                                <p class="body-p-sub m-0" style="line-height: 3">* Applicable fees to Dubai Land Department are: 4% of the property net price + AED 5,250 (VAT inc.) Oqood fee.</p>
                            ...
                            <div class="px-0 pb-4 my-5">
                                ...
                                <table class="table "> 
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[0] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[1] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[2] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p" style="color: #095edb;">{{ number_format( $unit->unit_price * 0.1) }}</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[3] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p" style="color: #095edb;">{{ number_format( $unit->unit_price * 0.05) }}</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[4] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p" style="color: #095edb;">{{ number_format( $unit->unit_price * 0.1) }}</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p">{{ $new_date_array[5] }}</span>
                                        </td>
                                        <td class="text-center" style="border-bottom: 1.5px #dbdbdb solid !important;">
                                            <span class="body-table-p" style="color: #095edb;">{{ number_format( $unit->unit_price * 0.1) }}</span>
                                        </td>
