<div class="card">
    <div class="card-body">
        <h3 class="mb-1">Floor Plan Segmenting</h3>
        <p class="mb-0 text-justify text-muted">
            <i>Real estate is not just about properties; it's about turning dreams into addresses</i>
        </p>



        <div class="my-4">
            <form class="contact-form" action="{{ route('unit-floor-plan.store')  }}" method="POST" enctype="multipart/form-data" id="dropzone"
            >
                @csrf
                ...
                <input type="hidden" value="secondary" name="type" hidden>
