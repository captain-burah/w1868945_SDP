...
<div class="card ">
    <div class="card-body">
        ...
        <div class="row mb-4 d-flex justify-content-between w-full">
            ...
            <div class="">
                <a href="{{ url('print_booking/'.$booking->id) }}" target="_blank" class="btn btn-dark btn-block btn-lg rounded-0">
                ...
                <div class="row">
                    ...
                    <div class="col-6 p-3 border">
                        <div class="d-flex" dir="rtl">
                            ...
                            &nbsp;:&nbsp; <span> ESNAAD Real Estate Development L.L.C </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6 p-3 border">
                    <div class="d-flex" dir="rtl">
                        ...
                        &nbsp;:&nbsp; <span>{{ \Carbon\Carbon::now()->format('jS \of F Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-6 p-3 border">
                    <div class="d-flex">
                        <p class="offer-headings">First Payment (Deposit): &nbsp; &nbsp;</p> <span>AED {{ number_format(($unit->unit_price * $unit->unit_paymentplan->unit_paymentplan_files[0]->percentage) / 100, 2) }}</span>
                    </div>
                </div>
                <div class="col-6 p-3 border">
                    <div class="d-flex" dir="rtl">
                        ...
                        &nbsp;:&nbsp; <span>AED {{ number_format(($unit->unit_price * $unit->unit_paymentplan->unit_paymentplan_files[0]->percentage) / 100, 2) }}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row my-0 mx-2 d-flex justify-content-between w-full">
            ...
            <div class="row my-4">
                <div class="col-6 p-3 border">
                    ...
                    <div class="d-flex my-4">
                        <p class="booking-form-para">Agency Representative's Name: {{$booking->bookingbrokers[0]->broker->broker_agents[0]->name}}</p>
                ...
                <div class="col-6 p-3 border">
                    <div class="d-flex my-4" dir="rtl">
                        <p class="booking-form-para">هل تمت معرفتك بالبائع من خلال وكلاء البائع المسجلين :  Yes </p>
                    ...
                    <div class="d-flex my-4" dir="rtl">
                        <p class="booking-form-para">اسم ممثل الوكالة : {{$booking->bookingbrokers[0]->broker->broker_agents[0]->name}}</p>
