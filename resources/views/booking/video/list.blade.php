                ...
                <div class="d-flex">
                    <div class="flex-grow-1 align-self-center">
                        <div class="text-muted">
                            <h4><i class="bx bx-video-recording text-dark font-size-24"></i> Video Segments</h4>
                            <br>
                            <p class="card-title-desc">The table consists of all video segments created for projects. This will be displayed only in the specific project page.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 d-none d-lg-block my-auto">
                <div class="clearfix mt-4 mt-lg-0 my-auto">
                    <div class="my-auto float-right">
                        <a href="{{ route('project-video.create') }}" class="btn btn-dark">
                    ...
                    @if(isset($count_status))
                        @foreach ($results as $data)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if($data->project_id != null)
                                                <a class="dropdown-item" style="cursor: pointer;" href="{{ url('project-video/disconnect/'.$data->id)  }}"><i class="bx bx-cloud-download"></i> &nbsp; Disconnect from Project</a>
                                            @else
                                ...
                                <td>{{ $data->project_video_files()->count() }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('project-video.edit', ['project_video' => $data->id]) }}"><i class="bx bx-edit text-dark"></i> &nbsp;Update</a>
                                            <a class="dropdown-item" href="{{ route('project-video.destroy.segment', ['id' => $data->id]) }}"><i class="bx bx-trash text-danger"></i> &nbsp;Remove</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="contact-form" id="getInTouch" method="post" action="{{ route('project-video.connect') }}">
                                            @csrf
