                ...
                <div class="d-flex">
                    <div class="flex-grow-1 align-self-center">
                        <div class="text-muted">
                            <h4><i class="bx bx-file-find text-dark font-size-24"></i> Factsheet Segments</h4>
                            <br>
                            <p class="card-title-desc">The table consists of all factsheet segments created for projects. This will be displayed only in the specific project page.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 d-none d-lg-block my-auto">
                <div class="clearfix mt-4 mt-lg-0 my-auto">
                    <div class="my-auto float-right">
                        <a href="{{ route('project-factsheet.create') }}" class="btn btn-dark">
                    ...
                    @if(isset($count_status))
                        @foreach ($results as $data)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if($data->project_id != null)
                                                <a class="dropdown-item" style="cursor: pointer;" href="{{ url('project-factsheet/disconnect/'.$data->id)  }}"><i class="bx bx-cloud-download"></i> &nbsp; Disconnect from Project</a>
                                            @else
                                ...
                                <td>{{ $data->project_factsheet_files()->count() }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('project-factsheet.edit', ['project_factsheet' => $data->id]) }}"><i class="bx bx-edit text-dark"></i> &nbsp;Update</a>
                                            <a class="dropdown-item" href="{{ route('project-factsheet.destroy.segment', ['id' => $data->id]) }}"><i class="bx bx-trash text-danger"></i> &nbsp;Remove</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="contact-form" id="getInTouch" method="post" action="{{ route('project-factsheet.connect') }}">
                                            @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('project-factsheet.edt', ['project-brochures', $data->id]) }}"><i class="bx bx-edit text-dark"></i> &nbsp;Update</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
