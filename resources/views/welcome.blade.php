                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a  class="scale-100 p-6 bg-white  from-gray-700/50 via-transparent    rounded-lg shadow-2xl shadow-gray-500/20   flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900   ">Property Management</h2>

                                <p class="mt-4 text-gray-500    text-sm leading-relaxed">
                                    Our Property Management System (PMS) is the ultimate solution for property owners, real estate investors, and property managers seeking to simplify and streamline their property management tasks with exquisite interactivity.
                                </p>
                            </div>
                        ...
                        <a  class="scale-100 p-6 bg-white          rounded-lg shadow-2xl shadow-gray-500/20   flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <div class="h-16 w-16 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-red-500">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900   ">ESNAAD Cast</h2>

                                <p class="mt-4 text-gray-500    text-sm leading-relaxed">
                                    Our Meeting Scheduler is a powerful tool designed to simplify and streamline the process of setting up meetings and appointments. With user-friendly features, it effortlessly manages your scheduling needs, helping you save time and eliminate the back-and-forth communication.
                                </p>
                            </div>
                        ...
                        <a  class="scale-100 p-6 bg-white          rounded-lg shadow-2xl shadow-gray-500/20   flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900   ">Booking Management</h2>

                                <p class="mt-4 text-gray-500    text-sm leading-relaxed">
                                     Property Booking Management system is your all-in-one solution for efficiently managing property reservations and bookings. Whether you're running a hotel, vacation rental, or event venue, our platform simplifies the entire booking process.
                        ...
                        <div class="scale-100 p-6 bg-white          rounded-lg shadow-2xl shadow-gray-500/20   flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900   ">ESNAAD Milestones</h2>

                                <p class="mt-4 text-gray-500    text-sm leading-relaxed">
                                    Our Payment Management system is your financial control center, streamlining and optimizing the handling of payments. From invoices to transactions, we provide a secure, efficient platform to track, process, and manage payments with ease.
                                </p>
                            </div>
                        </div>
                    </div>
