...
/**BROKER */
    ...
    Route::get('brokers/agent-create', [BrokerController::class, 'agent_create'])->name('brokers.agent.create');
    Route::post('brokers/agent-create', [BrokerController::class, 'agent_store'])->name('brokers.agent.store');
/**BROKER */
